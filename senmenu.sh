...
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/kanghory/Autoscript-vpn/main/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/kanghory/Autoscript-vpn/main/menu-trojan.sh"
